...
@section('content')
 ...
 <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <!-- Space for content onkeydown="clearErrorsNazivPismo()" onclick="validacijaPismo()"-->
            <div class="scroll height-content section-content">
                <form action="{{route('pismo.save')}}" method="post" class="text-gray-700 forma">
                @csrf    
