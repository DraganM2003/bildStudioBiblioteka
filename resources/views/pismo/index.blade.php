...
@section('content')
 ...
 <section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
            ...
            <div class="py-4 text-gray-500 border-b-[1px] border-[#e4dfdf] pl-[30px]">
                ...
                <a href="settingsPismo.php" class="inline ml-[70px] hover:text-blue-800 active-book-nav">
                    Pismo
                </a>
            </div>
            <div class="height-kategorije pb-[30px] scroll">
                ...
                <div
                    ...
                    <div class="flex success items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    @if(@session('fail'))
                        ...
                        <div class="flex fail items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                                ...
                                <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                <a href="{{route('pismo.edit',$pismo->Id)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                    <i class="fas fa-edit mr-[1px] ml-[5px] py-1"></i>
                                                    <span class="px-4 py-0">Izmijeni pismo</span>
                                                </a>
                                                <a href="{{route('pismo.delete',$pismo->Id)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
